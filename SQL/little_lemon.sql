CREATE DATABASE  IF NOT EXISTS `little_lemon` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `little_lemon`;
...
INSERT INTO `bookings` VALUES (1,12,'Anna','Iversen','20:00:00',1),(2,12,'Joakim','Iversen','19:00:00',1),(3,19,'Vanessa','McCarthy','15:00:00',3),(4,15,'Marcos','Romero','17:30:00',4),(5,5,'Hiroki','Yamane','18:30:00',2),(6,8,'Diana','Pinto','20:00:00',5),(7,8,'Anees','Java','18:00:00',6),(8,5,'Bald','Vin','19:00:00',6),(9,8,'Anees','Java','18:00:00',6),(10,5,'Bald','Vin','19:00:00',6),(14,1,'Fajri','Widiadi','19:00:00',NULL);
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `AddBooking`(IN table_no int, IN first_name varchar(45), IN last_name varchar(45), IN booking_slot time)
BEGIN
...
SELECT HOUR(bookings.BookingSlot) as hour, 
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `UpdateBooking`(IN existing_id int, IN new_time time)
BEGIN
UPDATE Bookings 
...
-- Dump completed on 2023-10-23  4:20:46
